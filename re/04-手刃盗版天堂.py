...
obj5 = re.compile(r'◎片　　名(?P<movie>.*?)<br />.*?<td '
...
for herf in child_herflist:
    ...
    result5=obj5.search(child_resp.text)
    if result5:
        print(result5.group("movie"),end="-------")
        print(result5.group("download"))
    # break  #用于测试作用
...
# print(child_herflist)
# result1=obj2.finditer(result)
# for i in result1:
#     print(i.group("wangzhan"))
